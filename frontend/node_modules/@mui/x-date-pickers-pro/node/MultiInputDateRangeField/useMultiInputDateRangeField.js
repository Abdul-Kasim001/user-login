...
var _useDateRangeField = require("../DateRangeField/useDateRangeField");
...
const useMultiInputDateRangeField = inProps => {
  ...
  const props = (0, _useDateRangeField.useDefaultizedDateRangeFieldProps)(inProps);
  ...
  const inputError = React.useMemo(() => _useDateRangeField.dateRangeFieldValueManager.hasError(validationError), [validationError]);
